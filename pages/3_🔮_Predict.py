...
selected_model = st.selectbox("Select model bundle", model_files)
use_pipeline = st.checkbox("Use separately saved pipeline")
...
if use_pipeline:
    ...
    if not pipeline_files:
        ...
        selected_pipeline = st.selectbox("Select saved pipeline", pipeline_files)
